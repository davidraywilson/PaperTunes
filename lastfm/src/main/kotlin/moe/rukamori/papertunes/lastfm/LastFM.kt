...
package moe.rukamori.papertunes.lastfm
...
import moe.rukamori.papertunes.lastfm.models.LastFmError
import moe.rukamori.papertunes.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "papertunes"
    const val FALLBACK_COMPAT_SECRET = "papertunes"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "PaperTunes (https://github.com/PaperTunesApp/PaperTunes)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
