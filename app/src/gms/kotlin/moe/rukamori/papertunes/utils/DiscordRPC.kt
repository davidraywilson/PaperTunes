...
package moe.rukamori.papertunes.utils
...
import moe.rukamori.papertunes.constants.DiscordActivityButton1CustomUrlKey
import moe.rukamori.papertunes.constants.DiscordActivityButton1EnabledKey
import moe.rukamori.papertunes.constants.DiscordActivityButton1LabelKey
import moe.rukamori.papertunes.constants.DiscordActivityButton1UrlSourceKey
import moe.rukamori.papertunes.constants.DiscordActivityButton2CustomUrlKey
import moe.rukamori.papertunes.constants.DiscordActivityButton2EnabledKey
import moe.rukamori.papertunes.constants.DiscordActivityButton2LabelKey
import moe.rukamori.papertunes.constants.DiscordActivityButton2UrlSourceKey
import moe.rukamori.papertunes.constants.DiscordActivityDetailsKey
import moe.rukamori.papertunes.constants.DiscordActivityNameKey
import moe.rukamori.papertunes.constants.DiscordActivityPlatformKey
import moe.rukamori.papertunes.constants.DiscordActivityStateKey
import moe.rukamori.papertunes.constants.DiscordActivityTypeKey
import moe.rukamori.papertunes.constants.DiscordLargeImageCustomUrlKey
import moe.rukamori.papertunes.constants.DiscordLargeImageTypeKey
import moe.rukamori.papertunes.constants.DiscordLargeTextCustomKey
import moe.rukamori.papertunes.constants.DiscordLargeTextSourceKey
import moe.rukamori.papertunes.constants.DiscordPresenceStatusKey
import moe.rukamori.papertunes.constants.DiscordShowWhenPausedKey
import moe.rukamori.papertunes.constants.DiscordSmallImageCustomUrlKey
import moe.rukamori.papertunes.constants.DiscordSmallImageTypeKey
import moe.rukamori.papertunes.constants.EnableTranslatorKey
import moe.rukamori.papertunes.constants.TranslatorContextsKey
import moe.rukamori.papertunes.constants.TranslatorTargetLangKey
import moe.rukamori.papertunes.db.entities.Song
import moe.rukamori.papertunes.discord.DiscordActivityPlatform
import moe.rukamori.papertunes.discord.DiscordActivityType
import moe.rukamori.papertunes.discord.DiscordOnlineStatus
import moe.rukamori.papertunes.discord.DiscordPresenceActivity
import moe.rukamori.papertunes.discord.DiscordPresenceAssets
import moe.rukamori.papertunes.discord.DiscordPresenceButton
import moe.rukamori.papertunes.discord.DiscordPresenceTimestamps
import moe.rukamori.papertunes.discord.DiscordSocialPresenceClient
import moe.rukamori.papertunes.discord.DiscordStatusDisplayType
...
class DiscordRPC(
    ...
    companion object {
        private const val PAUSE_IMAGE_URL =
            "https://raw.githubusercontent.com/koiverse/PaperTunes/main/fastlane/metadata/android/en-US/images/RPC/pause_icon.png"
        private const val APP_ICON_URL =
            "https://raw.githubusercontent.com/koiverse/PaperTunes/main/fastlane/metadata/android/en-US/images/icon.png"
    ...
    private suspend fun resolveButtons(song: Song): List<DiscordPresenceButton> {
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to PaperTunes"
        ...
        val button2CustomUrl =
            context.dataStore[DiscordActivityButton2CustomUrlKey]
                ?: "https://github.com/PaperTunesApp/PaperTunes"
