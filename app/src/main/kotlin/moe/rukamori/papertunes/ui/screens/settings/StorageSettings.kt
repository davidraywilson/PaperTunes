...
import moe.rukamori.papertunes.constants.MaxImageCacheSizeKey
...
import moe.rukamori.papertunes.extensions.tryOrNull
import moe.rukamori.papertunes.storage.StorageFolderKind
import moe.rukamori.papertunes.storage.StorageLocationKind
...
import moe.rukamori.papertunes.ui.player.CanvasArtworkPlaybackCache
import moe.rukamori.papertunes.ui.utils.backToMain
import moe.rukamori.papertunes.ui.utils.formatFileSize
import moe.rukamori.papertunes.utils.rememberPreference
import moe.rukamori.papertunes.viewmodels.StorageFolderUiModel
import moe.rukamori.papertunes.viewmodels.StorageCacheClearUiKind
import moe.rukamori.papertunes.viewmodels.StorageCacheClearUiModel
import moe.rukamori.papertunes.viewmodels.StorageLocationUiModel
import moe.rukamori.papertunes.viewmodels.StorageLocationUiOptions
import moe.rukamori.papertunes.viewmodels.StorageMigrationUiModel
import moe.rukamori.papertunes.viewmodels.StorageMigrationUiPhase
import moe.rukamori.papertunes.viewmodels.StorageSettingsScreenState
import moe.rukamori.papertunes.viewmodels.StorageSettingsViewModel
            ...
            PreferenceGroup(title = stringResource(R.string.downloaded_songs)) {
                item {
                    val (forceHighQualityDownloads, onForceHighQualityDownloadsChange) =
                        rememberPreference(
                            key = moe.rukamori.papertunes.constants.ForceHighQualityDownloadsKey,
                            defaultValue = false,
                        )
                    SwitchPreference(
