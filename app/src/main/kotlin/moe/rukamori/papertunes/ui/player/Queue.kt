...
import moe.rukamori.papertunes.constants.QueueEditLockKey
...
import moe.rukamori.papertunes.ui.component.MediaMetadataListItem
import moe.rukamori.papertunes.ui.menu.AddToPlaylistDialog
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is moe.rukamori.papertunes.together.TogetherSessionState.Joined &&
            (togetherSessionState as moe.rukamori.papertunes.together.TogetherSessionState.Joined).role is moe.rukamori.papertunes.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? moe.rukamori.papertunes.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is moe.rukamori.papertunes.together.TogetherRole.Guest
                                                                if (isGuest) {
