...
import moe.rukamori.papertunes.App
import com.paperapps.papertunes.BuildConfig
import moe.rukamori.papertunes.constants.DailyNightlyReleasesEtagKey
import moe.rukamori.papertunes.constants.DailyNightlyReleasesFingerprintKey
import moe.rukamori.papertunes.constants.DailyNightlyReleasesJsonKey
import moe.rukamori.papertunes.constants.DailyNightlyReleasesLastCheckedAtKey
import moe.rukamori.papertunes.constants.GitHubReleasesEtagKey
import moe.rukamori.papertunes.constants.GitHubReleasesFingerprintKey
import moe.rukamori.papertunes.constants.GitHubReleasesJsonKey
import moe.rukamori.papertunes.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private const val StableDownloadUrl = "https://github.com/PaperTunesApp/PaperTunes/releases/latest"
    private const val DailyNightlyDownloadUrl =
        "https://github.com/PaperTunesApp/daily-nightly/releases/latest"
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/PaperTunesApp/PaperTunes/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "PaperTunes")
    ...
    suspend fun getCommitHistory(
        ...
        runCatching {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/PaperTunesApp/PaperTunes/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        ...
        if (tag != null) {
            return "https://github.com/PaperTunesApp/PaperTunes/releases/download/$tag/app-$distributionArtifactPrefix${BuildConfig.DEVICE}-${BuildConfig.ARCHITECTURE}-release.apk"
        }
    ...
    fun getLatestNightlyDownloadUrl(): String {
        ...
        return "https://nightly.link/PaperTunesApp/PaperTunes/workflows/build/dev/app-$distributionArtifactPrefix${BuildConfig.DEVICE}-${BuildConfig.ARCHITECTURE}-release"
    }
    ...
    private suspend fun fetchDailyNightlyReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/PaperTunesApp/daily-nightly/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "PaperTunes")
                    if (!cachedEtag.isNullOrBlank()) {
    ...
    fun getLatestDailyNightlyDownloadUrl(): String {
        ...
        if (tag != null) {
            return "https://github.com/PaperTunesApp/daily-nightly/releases/download/$tag/app-$distributionArtifactPrefix${BuildConfig.DEVICE}-${BuildConfig.ARCHITECTURE}-nightly.apk"
        }
