...
package moe.rukamori.papertunes.library
...
import moe.rukamori.papertunes.ai.AiTextService
...
import moe.rukamori.papertunes.repository.LibraryTopMixRepository
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for PaperTunes.
...
private fun List<moe.rukamori.papertunes.innertube.models.Artist>.matchesAnyLocalArtist(song: Song): Boolean {
