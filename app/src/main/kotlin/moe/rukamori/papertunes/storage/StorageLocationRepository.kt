...
package moe.rukamori.papertunes.storage
...
import moe.rukamori.papertunes.constants.GitHubContributorsEtagKey
import moe.rukamori.papertunes.constants.GitHubContributorsJsonKey
import moe.rukamori.papertunes.constants.GitHubContributorsLastCheckedAtKey
import moe.rukamori.papertunes.constants.GitHubTranslationContributorsJsonKey
import moe.rukamori.papertunes.constants.GitHubTranslationContributorsLastCheckedAtKey
import moe.rukamori.papertunes.constants.StorageFolderDisplayNameKey
import moe.rukamori.papertunes.constants.StorageFolderIdKey
import moe.rukamori.papertunes.constants.StorageFolderPathKey
import moe.rukamori.papertunes.constants.StorageFolderTreeUriKey
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".papertunes-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "PaperTunes"
...
private const val SavedArtworkCacheFileName = "papertunes_saved_artworks.json"
