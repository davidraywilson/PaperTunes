...
import moe.rukamori.papertunes.canvas.PaperTunesCanvas
import moe.rukamori.papertunes.constants.*
import moe.rukamori.papertunes.extensions.*
import moe.rukamori.papertunes.innertube.YouTube
import moe.rukamori.papertunes.innertube.models.YouTubeLocale
import moe.rukamori.papertunes.kugou.KuGou
import moe.rukamori.papertunes.lastfm.LastFM
import moe.rukamori.papertunes.paxsenix.PaxsenixLyrics
...
import moe.rukamori.papertunes.ui.screens.settings.ThemePalettes
import moe.rukamori.papertunes.ui.theme.ThemeSeedPalette
import moe.rukamori.papertunes.ui.theme.ThemeSeedPaletteCodec
import moe.rukamori.papertunes.utils.PreferenceStore
import moe.rukamori.papertunes.utils.ProxyUtils
import moe.rukamori.papertunes.utils.YTPlayerUtils
import moe.rukamori.papertunes.utils.clearPlaybackAuthSession
import moe.rukamori.papertunes.utils.clearPlaybackWebAuthSession
...
class App :
    ...
    private fun initializeCriticalSync() {
        ...
        PaperTunesCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
        PaxsenixLyrics.setUserAgent("PaperTunes", BuildConfig.VERSION_NAME)
